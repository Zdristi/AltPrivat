...
@dp.callback_query_handler(lambda c: c.data == 'show_tariff_main')
...
@dp.callback_query_handler(lambda c: c.data == 'show_tariff_photo_legs')
...
@dp.callback_query_handler(lambda c: c.data == 'show_tariff_juicy_altushki')
...
@dp.callback_query_handler(lambda c: c.data == 'show_tariff_mini_sampler')
...
@dp.callback_query_handler(lambda c: c.data == 'payment_card')
...
@dp.callback_query_handler(lambda c: c.data == 'payment_stars')
...
@dp.callback_query_handler(lambda c: c.data == 'payment_crypto')
...
@dp.callback_query_handler(lambda c: c.data == 'subscribe_channel')
